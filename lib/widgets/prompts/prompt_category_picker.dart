...
class PromptCategoryPicker extends StatelessWidget {
  ...
  /// Show voice prompt question picker
  static Future<void> showVoicePromptPicker({
    required BuildContext context,
    required Function(String question) onQuestionSelected,
  }) {
    return showModalBottomSheet(
      context: context,
      isScrollControlled: true,
                      ...
                      child: Row(
                        children: [
                          Container(
                            ...
                            child: const Icon(Icons.mic, color: Colors.deepOrange, size: 22),
                          ),
                          const SizedBox(width: 14),
                          Expanded(
                            child: Text(
